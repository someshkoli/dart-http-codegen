...
self = module.exports = {
  ...
  */
  ...
  convert: function (request, options, callback) {
    ...
    'const data = payload, files = files' : ', data = payload\n';
    snippet += `${getheaders(request, indentation)}\n`;
    snippet += `const response = await http.${request.method.toLowerCase()}(url, headers: headers, body: payload);\n`;
    snippet += `print(response);`;
    snippet += '\n}';
    console.log(snippet);
  }
}
